package com.example.jiangwensai.modulebase.net;
...
public class HttpHelper {
    ...
    private static HashMap<String, HttpHelper> sRetrofitManager = new LinkedHashMap<>();
...
//        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd'ToastUtils'HH:mm:ssZ").serializeNulls().create();
  ...
  /*  public static HttpHelper getDefault(int hostType) {
    ...
    public static Retrofit getDefault(String baseUrl) {
        HttpHelper retrofitManager = sRetrofitManager.get(baseUrl);
        if (retrofitManager == null) {
            retrofitManager = new HttpHelper(baseUrl);
